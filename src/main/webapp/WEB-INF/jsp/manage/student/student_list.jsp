...
<body class="no-skin">
										...
										<td>
											<div class="nav-search">
												<span class="input-icon">
													<input type="text" placeholder="请输入学生姓名" class="nav-search-input" 
													id="studentName" autocomplete="off" name="studentName" value="${pd.studentName }"/>
												</span>
											</div>
										</td>
										<td style="padding-left: 2px;"><input
											class="span10 date-picker" name="lastStart" id="lastStart"
											value="${pd.lastStart }" type="text" data-date-format="yyyy-mm-dd"
	...
	<script type="text/javascript">
		...
		function toChooseSeat(){
			window.location.href='<%=basePath%>student/chooseSeat.do';
		}
	</script>
