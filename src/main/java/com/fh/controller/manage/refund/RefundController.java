package com.fh.controller.manage.refund;
...
import com.fh.service.manage.refund.RefundManager;
...
public class RefundController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("manage/refund/refund_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("manage/refund/refund_edit");
	...
	public Object deleteAll() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"批量删除Refund");
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			refundService.deleteAll(ArrayDATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("STU_ID"));	    //1
			vpd.put("var2", varOList.get(i).getString("REFUND_AMOUNT"));	    //2
